      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs rounded-xl bg-white border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-800 placeholder-slate-400"
          />
        </div>
      </div>
      ...
      {filtered.length > 0 ? (
          ...
          {filtered.map((exercise) => {
            ...
            return (
              <div
                ...
                className="group bg-white rounded-2xl border border-slate-200/90 hover:border-blue-300 p-4 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between"
              >
                <div>
                  {/* Top Meta Bar */}
                  <div className="flex items-center justify-between gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] text-slate-500">
                      <span className="flex items-center gap-0.5 font-semibold text-blue-700 bg-blue-50 px-2 py-0.5 rounded-md">
                        <Clock className="w-3 h-3" />
                        60s
                      </span>
                      {exercise.participantMode === 'duo' ? (
                        <span className="flex items-center gap-0.5 text-sky-800 bg-sky-50 px-1.5 py-0.5 rounded-md font-medium">
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-blue-50 hover:bg-blue-600 text-blue-700 hover:text-white font-bold text-xs flex items-center gap-1.5 transition-all active:scale-95 group-hover:bg-blue-600 group-hover:text-white"
                  >
        ...
        <div className="text-center py-12 bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <button
            ...
            className="mt-3 px-4 py-2 rounded-xl bg-blue-600 text-white font-semibold text-xs hover:bg-blue-700 transition-colors"
          >
